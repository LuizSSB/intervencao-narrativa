...
{
	NSError *error = [NSError errorWithDomain:FTINErrorDomainDefault code:code userInfo:[NSMutableDictionary dictionaryWithObject:customMsg forKey:NSLocalizedDescriptionKey]];
	return error;
}
