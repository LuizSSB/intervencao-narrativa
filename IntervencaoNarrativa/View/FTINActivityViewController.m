...
- (void)viewDidLoad
{
	...
	// Luiz: só para teste. Não deve fazer diferença alguma.
...
{
#warning fixme remover
	FTINDescriptiveSkillViewController *choiceVC = [[FTINDescriptiveSkillViewController alloc] init];
	popover = [[UIPopoverController alloc] initWithContentViewController:choiceVC];
	popover.popoverContentSize = CGSizeMake(320, [FTINDescriptiveSkillViewController defaultChoices].count * choiceVC.tableView.rowHeight);
